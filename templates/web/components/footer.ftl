	...
	<div class="container">
		<div class="row">
			...
			<div class="wow fadeInUp col-md-3 col-sm-4" data-wow-delay="1s">
				<@studio.h2 $field="sns_titleText_t">
			...
			<div class="col-md-12 col-sm-12">
				<p class="copyright-text">
					Copyright &copy;
					<@studio.span $field="year_s">
						${contentModel.year_s}
					</@studio.span>
					<@studio.span $field="companyName_t">
